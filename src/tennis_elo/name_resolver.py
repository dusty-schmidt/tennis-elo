...
class PlayerNameResolver:
    ...
    def resolve_name(self, query: str, tour: Optional[str] = None) -> Optional[Dict]:
        """
    ...
    def _get_player_by_id(self, player_id: int, tour: Optional[str] = None) -> Optional[Dict]:
    ...
    def search_players(self, query: str, tour: Optional[str] = None, limit: int = 10) -> List[Dict]:
        """
