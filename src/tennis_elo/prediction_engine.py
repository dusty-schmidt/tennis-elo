...
class TennisPredictionEngine:
    ...
    def __init__(self, db_path=DB_PATH):
        ...
        self.category_multipliers = {
            'Grand Slam': 1.2, 'ATP Finals': 1.1, 'WTA Finals': 1.1,
            'Masters 1000': 1.15, 'WTA 1000': 1.15,
            'ATP 500': 1.0, 'WTA 500': 1.0,
            'ATP 250': 0.9, 'WTA 250': 0.9, 'default': 1.0
        }
    ...
    def resolve_player(self, name: str, tour: str = None) -> Optional[Dict]:
    ...
    def get_player_elo(self, player_name: str, tour: str = None) -> Optional[Dict]:
    ...
    def get_player_yelo(self, player_name: str, tour: str = None) -> Optional[Dict]:
    ...
    def calculate_surface_adjusted_elo(self, player_elo: Dict, surface: str, tour: str, 
                                       category: str = 'default') -> tuple:
        ...
        adjusted_elo = (1 - effective_lambda) * player_elo['overall_elo'] + effective_lambda * surface_elo
    ...
    def predict_match(self, player1_name: str, player2_name: str, tournament_name: str) -> Optional[Dict]:
        ...
        p1_surface_elo, p1_lambda = self.calculate_surface_adjusted_elo(player1_elo, surface, tour, category)
        p2_surface_elo, p2_lambda = self.calculate_surface_adjusted_elo(player2_elo, surface, tour, category)
        ...
        return {
            ...
            "prediction": {
                ...
                "yelo_blend_weight": round(avg_yelo_weight if player1_yelo and player2_yelo else 0, 3),
...
if __name__ == "__main__":
    ...
    if "error" not in result:
        ...
        print(f"{p2['name']}: {p2['win_percentage']} (yELO: {p2['yelo']}, {p2['yelo_matches']} matches)")
